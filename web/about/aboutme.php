...
<body>
    <div class="container">
        ...
        <section class="section section2">
            ...
            <p>Some of my favorite movies, include Star Wars, at least since I watched all the first 6 movies before
                the
        ...
        <section class="section section1">
            ...
            <h2>Background</h2>
            <img src="programming.png" class="images" alt="A laptop used by a web developer" title="Photo by Fatos Bytyqi on Unsplash.com">
            <br>
            <br>
            ...
            <p>I am eager to learn, and I am always occupied trying to learn and understand new technologies. I like to
                challenge my knowledge in order to grow.</p>
            </p>
        </section>
    </div>
    <hr>
