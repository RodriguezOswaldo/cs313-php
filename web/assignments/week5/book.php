...
<body>
...

    {
        ...
        echo "<li><a href='booksinfo.php?book_id=$id'>$title</a> <a href='href='update.php?book_id=$id' class='btn-outline-success'>Update</a> | <a class='btn-outline-danger'>Delete</a></li>";
    }    
    ?>
    </ul>
