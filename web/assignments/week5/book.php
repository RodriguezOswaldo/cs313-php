...
<body>
...

    {
        ...
        echo "<li><a href='booksinfo.php?book_id=$id'>$title</a> <a href='update.php?book_id=$id' class='btn-success'>Update</a> | <a href='delete.php' class='btn-danger'>Delete</a></li>";
    }    
    ?>
    </ul>
